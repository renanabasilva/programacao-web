...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29/08/2024 às 17:34
...
ALTER TABLE `autor_livro`
  ADD CONSTRAINT `autor_livro_ibfk_1` FOREIGN KEY (`cod_autor`) REFERENCES `autor` (`cod_autor`),
  ADD CONSTRAINT `autor_livro_ibfk_2` FOREIGN KEY (`cod_livro`) REFERENCES `livro` (`cod_livro`);

--
-- Restrições para tabelas `requisicao`
--
ALTER TABLE `requisicao`
  ADD CONSTRAINT `requisicao_ibfk_1` FOREIGN KEY (`num_utente`) REFERENCES `utente` (`num_utente`),
  ADD CONSTRAINT `requisicao_ibfk_2` FOREIGN KEY (`cod_livro`) REFERENCES `livro` (`cod_livro`);
COMMIT;
