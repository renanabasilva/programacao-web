...
<article class="container">
	<section>
		<h1 class="titulo-sobre">A Mirror Fashion</h1>
		<p>
		...
		<p>
			...
			<a target="_blank" href="https://www.google.com.br/maps?q=Jacarezinho">Jacarezinho, no Paraná</a>. De lá, saem 48 aviões que distribuem nossos produtos às casas do
		...
		<p>
			...
			<a href="index.php">nossa loja</a> ou entre em contato se tiver
	...
	<section>
		...
		<p>
			...
			interior do Paraná. A <em>família Pelho</em>, tradicional da região,
			investiu todas as suas economias nessa nova iniciativa, revolucionária
			para a época. O fundador <em>Eduardo Simões Pelho</em>, dotado de
			particular visão administrativa, guiou os negócios da empresa durante
			mais de 50 anos, muitos deles ao lado de seu filho
			<em>E. S. Pelho Filho</em>, atual CEO. O nome da empresa é inspirado
			no nome da família.
		</p>
		<p>
	...
	<section>
		...
		<ul id="lista-diferenciais">
			...
			<li>
				Atendimento via telefone, email, chat, twitter, facebook, carta, fax
				e telegrama
			</li>
